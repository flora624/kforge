        ...
        <header className="hero-section">
          <div className="container hero-content">
              ...
              <div className="hero-buttons">
                ...
                <a href="#features" className="btn btn-outline btn-large float-advantage"><i className="fas fa-play"></i>Watch Demo</a>
              </div>
        ...
        <main>
          ...
          <section className="community-section">
            <div className="container">
              ...
              <p className="section-subtitle">Connect with fellow builders, share your projects, and grow together.</p>
              <div className="community-stats">
                <div className="stat-card"><i className="fas fa-users"></i><h3>25,000+</h3><p>Active Builders</p></div>
              ...
              <div className="cta-section">
                ...
                <p>Join thousands of builders who've transformed their careers through hands-on project experience.</p>
                <div className="cta-buttons">
                  <Link href="/signup"><a><span>Join</span><i className="icon" /></a></Link>
                  <Link href="/community"><a><span>Join</span><i className="icon" /></a></Link>
                </div>
              </div>
            </div>
          </section>
